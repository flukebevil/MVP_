...
class RunnerApp : AppCompatActivity(), BaseView , Contacter.View{
    ...
    lateinit var model: Contacter.Model
...
//        presenter.OnClicked()
    ...
    override fun OnEvents() {
        ...
        btn_submit.setOnClickListener(View.OnClickListener {
            model = Models(edt_name.text.toString(),cb_cream.isChecked.toString(),cb_chocolate.isChecked.toString()
                    ,edt_quan.text.toString())

            presenter.OnClicked(model, this , this)
